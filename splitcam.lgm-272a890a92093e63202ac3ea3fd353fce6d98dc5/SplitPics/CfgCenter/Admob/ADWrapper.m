...
+(void) initAdNetwork:(NSArray*)adconfig_list withCallback:(void (^)())finishCallback {
    ...
    GADMobileAds.sharedInstance.requestConfiguration.testDeviceIdentifiers = @[  @"0139825a9ce423fecdee5de405290b86" ];
#endif
#ifdef AD_APPLOVIN_MAX
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"AppLovin-Settings" ofType:@"plist"];
    NSDictionary *appLovinDict = [NSDictionary dictionaryWithContentsOfFile:path];
    NSString* sdkKey = appLovinDict[@"SdkKey"];
