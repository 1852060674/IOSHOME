...
@interface ZBTemplate5_6_View()<UIScrollViewDelegate>
{
    float _currentWidth;
    ...
    float _outImageWidth;
    float _outImageHeight;
    float _outImageSecondWidth;
    float _outImageSecondHeight;
...
@end
@implementation ZBTemplate5_6_View
...
- (void)calculatedParameters
{
    ...
    /**** 角度计算 *****/
    _outImageWidth = (_currentWidth-_gap)*0.5;
    _outImageHeight = (_currentHeight-_gap)*0.5;
    
    _middleImageWidth = _currentWidth*0.5;
    _middleImageHeight = _currentHeight*0.5;
    
    _outImageSecondWidth = _middleImageWidth*0.5 - _gap;
    _outImageSecondHeight = _middleImageHeight*0.5 - _gap;
...
- (void)loadImages
{
    ...
    _leftUpImage = [ImageUtil getScaleImage:_leftUpImage withWidth:_outImageWidth andHeight:_outImageHeight];
    _leftDownImage = [ImageUtil getScaleImage:_leftDownImage withWidth:_outImageWidth andHeight:_outImageHeight];
    _rightUpImage = [ImageUtil getScaleImage:_rightUpImage withWidth:_outImageWidth andHeight:_outImageHeight];
    _rightDownImage = [ImageUtil getScaleImage:_rightDownImage withWidth:_outImageWidth andHeight:_outImageHeight];
...
- (void)createScrollView
{
    if (self.imagesArray.count == 5) {
        /********* the firt image ***************/
        ZBIrregularCollageScrollView *_scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap, _gap, _outImageWidth, _outImageHeight)];
        ...
        [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_outImageSecondWidth, _leftUpImage.size.height-_scrollView.frame.size.height);
        [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_outImageSecondWidth, _leftUpImage.size.height- _outImageSecondHeight);
        [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_scrollView.frame.size.width, _leftUpImage.size.height- _outImageSecondHeight);
        [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        ...
        /********* the second image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap, _gap+_outImageHeight+_gap, _outImageWidth, _outImageHeight)];
        _scrollView.delegate = self;
        ...
        [self.leftDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_scrollView.frame.size.width, _leftDownImage.size.height-(_scrollView.frame.size.height-_outImageSecondHeight));
        [self.leftDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_outImageSecondWidth, _leftDownImage.size.height-(_scrollView.frame.size.height-_outImageSecondHeight));
        [self.leftDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_outImageSecondWidth, _leftDownImage.size.height);
        [self.leftDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        ...
        /********* the third image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap+_outImageWidth+_gap, _gap, _outImageWidth, _outImageHeight)];
        _scrollView.delegate = self;
        ...
        p = CGPointMake(0, _rightUpImage.size.height-_outImageSecondHeight);
        [self.rightUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_scrollView.frame.size.width-_outImageSecondWidth, _rightUpImage.size.height-_outImageSecondHeight);
        [self.rightUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_scrollView.frame.size.width-_outImageSecondWidth, _rightUpImage.size.height-_scrollView.frame.size.height);
        [self.rightUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        ...
        /********* the fourth image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap+_currentWidth-_outImageWidth, _gap+_currentHeight-_outImageHeight, _outImageWidth, _outImageHeight)];
        _scrollView.delegate = self;
        _scrollView.tag = kIrregularScrollViewStartTag+3;
        _scrollView.originImage = [self.imagesArray objectAtIndex:3];
        
        p = CGPointMake(0, _rightDownImage.size.height- (_scrollView.frame.size.height-_outImageSecondHeight));
        ...
        [self.rightDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_scrollView.frame.size.width-_outImageSecondWidth, _rightDownImage.size.height);
        [self.rightDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_scrollView.frame.size.width-_outImageSecondWidth, _rightDownImage.size.height- (_scrollView.frame.size.height-_outImageSecondHeight));
        [self.rightDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        ...
        /********* the fifth image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap+_outImageSecondWidth+_gap, _gap+_outImageSecondHeight+_gap, _middleImageWidth, _middleImageHeight)];
        _scrollView.delegate = self;
...
- (void)loadScrollViews
{
    ...
    if (self.imagesArray.count == 5) {
        ...
        _scrollView.frame = CGRectMake(_gap, _gap, _outImageWidth, _outImageHeight);
        _scrollView.delegate = self;
        ...
        _scrollView.frame = CGRectMake(_gap, _gap+_outImageHeight+_gap, _outImageWidth, _outImageHeight);
        _scrollView.delegate = self;
        ...
        _scrollView.frame = CGRectMake(_gap+_outImageWidth+_gap, _gap, _outImageWidth, _outImageHeight);
        _scrollView.delegate = self;
        ...
        _scrollView.frame = CGRectMake(_gap+_currentWidth-_outImageWidth, _gap+_currentHeight-_outImageHeight, _outImageWidth, _outImageHeight);
        _scrollView.delegate = self;
        ...
        _scrollView.frame = CGRectMake(_gap+_outImageSecondWidth+_gap, _gap+_outImageSecondHeight+_gap, _middleImageWidth, _middleImageHeight);
        _scrollView.delegate = self;
...
- (void)setSelectedImage:(UIImage*)image
{
    ...
    switch (_selectedIndex) {
        case 0:
        {
            ...
            _leftUpImage = [ImageUtil getScaleImage:image withWidth:_outImageWidth andHeight:_outImageHeight];
            [self.leftUpPointArray removeAllObjects];
        ...
        case 1:
        {
            ...
            _scrollView.originImage = image;
            _leftDownImage = [ImageUtil getScaleImage:image withWidth:_outImageWidth andHeight:_outImageHeight];
            [self.leftDownPointArray removeAllObjects];
        ...
        case 2:
        {
            ...
            _scrollView.originImage = image;
            _rightUpImage = [ImageUtil getScaleImage:image withWidth:_outImageWidth andHeight:_outImageHeight];
            [self.rightUpPointArray removeAllObjects];
        ...
        case 3:
        {
            ...
            _scrollView.originImage = image;
            _rightDownImage = [ImageUtil getScaleImage:image withWidth:_outImageWidth andHeight:_outImageHeight];
            [self.rightDownPointArray removeAllObjects];
