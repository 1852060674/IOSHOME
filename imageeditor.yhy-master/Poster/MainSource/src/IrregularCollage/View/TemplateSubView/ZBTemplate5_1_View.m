...
@interface ZBTemplate5_1_View()<UIScrollViewDelegate>
{
    float _currentWidth;
...
@implementation ZBTemplate5_1_View
...
- (void)calculatedParameters
{
    ...
    _atan = atan(0.5*_gap/sqrt((_radius*_radius-0.25*_gap*_gap)));
}
...
- (void)loadImages
{
    ...
    _leftUpImage = [ImageUtil getScaleImage:_leftUpImage withWidth:_currentWidth*0.5-0.5*_gap andHeight:_currentHeight*0.5-0.5*_gap];
    _leftDownImage = [ImageUtil getScaleImage:_leftDownImage withWidth:_currentWidth*0.5-0.5*_gap andHeight:_currentHeight*0.5-0.5*_gap];
    _rightUpImage = [ImageUtil getScaleImage:_rightUpImage withWidth:_currentWidth*0.5-0.5*_gap andHeight:_currentHeight*0.5-0.5*_gap];
    _rightDownImage = [ImageUtil getScaleImage:_rightDownImage withWidth:_currentWidth*0.5-0.5*_gap andHeight:_currentHeight*0.5-0.5*_gap];
...
- (void)createScrollView
{
    if (self.imagesArray.count == 5) {
        /********* the firt image ***************/
        ZBIrregularCollageScrollView *_scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap, _gap, _currentWidth*0.5-0.5*_gap, _currentHeight*0.5-0.5*_gap)];
        _scrollView.delegate = self;
        _scrollView.tag = kIrregularScrollViewStartTag;
        _scrollView.originImage = [self.imagesArray objectAtIndex:0];
        
        CGPoint p = CGPointMake(_middleMinusWidth-2, _leftUpImage.size.height-_scrollView.frame.size.height);;
        ...
        [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_scrollView.frame.size.width, _leftUpImage.size.height-_middleMinusHeight);
        [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        
        _scrollView.imageView.image = [ImageUtil draw5_1_Image:_leftUpImage withPoints:self.leftUpPointArray withCenter:CGPointMake(_scrollView.frame.size.width+_gap*0.5, _leftUpImage.size.height-_scrollView.frame.size.height-0.5*_gap) radius:_radius+_gap startAngle:M_PI_2+_atan endAngle:0-_atan clockwise:YES];
...
//        [_scrollView setContentOffset:CGPointMake((_scrollView.contentSize.width-_scrollView.frame.size.width)/2, (_scrollView.contentSize.height-_scrollView.frame.size.height)/2)];
        ...
        /********* the second image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap, _gap+_currentHeight*0.5+0.5*_gap, _currentWidth*0.5-0.5*_gap, _currentHeight*0.5-0.5*_gap)];
        _scrollView.delegate = self;
        _scrollView.tag = kIrregularScrollViewStartTag+1;
        _scrollView.originImage = [self.imagesArray objectAtIndex:1];
        
        p = CGPointMake(_scrollView.frame.size.width, _leftDownImage.size.height-(_scrollView.frame.size.height - _middleMinusHeight));
        ...
        [self.leftDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_middleMinusWidth, _leftDownImage.size.height);
        [self.leftDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        
        _scrollView.imageView.image = [ImageUtil draw5_1_Image:_leftDownImage withPoints:self.leftDownPointArray withCenter:CGPointMake(_scrollView.frame.size.width+_gap*0.5, _leftDownImage.size.height+0.5*_gap) radius:_radius+_gap startAngle:M_PI+_atan endAngle:1.5*M_PI-_atan clockwise:YES];
...
//        [_scrollView setContentOffset:CGPointMake((_scrollView.contentSize.width-_scrollView.frame.size.width)/2, (_scrollView.contentSize.height-_scrollView.frame.size.height)/2)];
        ...
        /********* the third image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap+_currentWidth*0.5+0.5*_gap, _gap, _currentWidth*0.5-0.5*_gap, _currentHeight*0.5-0.5*_gap)];
        _scrollView.delegate = self;
        _scrollView.tag = kIrregularScrollViewStartTag+2;
        _scrollView.originImage = [self.imagesArray objectAtIndex:2];
        
        p = CGPointMake(0, _rightUpImage.size.height- _middleMinusHeight);
        ...
        [self.rightUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_scrollView.frame.size.width-_middleMinusWidth, _rightUpImage.size.height-_scrollView.frame.size.height);
        [self.rightUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        
        _scrollView.imageView.image = [ImageUtil draw5_1_Image:_rightUpImage withPoints:self.rightUpPointArray withCenter:CGPointMake(-_gap*0.5, _rightUpImage.size.height-_scrollView.frame.size.height-0.5*_gap) radius:_radius+_gap startAngle:0+_atan endAngle:M_PI_2-_atan clockwise:YES];
...
//        [_scrollView setContentOffset:CGPointMake((_scrollView.contentSize.width-_scrollView.frame.size.width)/2, (_scrollView.contentSize.height-_scrollView.frame.size.height)/2)];
        ...
        /********* the fourth image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap+_currentWidth*0.5+0.5*_gap, _gap+_currentHeight*0.5+0.5*_gap, _currentWidth*0.5-0.5*_gap, _currentHeight*0.5-0.5*_gap)];
        _scrollView.delegate = self;
        _scrollView.tag = kIrregularScrollViewStartTag+3;
        _scrollView.originImage = [self.imagesArray objectAtIndex:3];
        
        p = CGPointMake(_scrollView.frame.size.width-_middleMinusWidth, _rightDownImage.size.height);
        ...
        [self.rightDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(0, _rightDownImage.size.height - (_scrollView.frame.size.height - _middleMinusHeight));
        [self.rightDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        
        _scrollView.imageView.image = [ImageUtil draw5_1_Image:_rightDownImage withPoints:self.rightDownPointArray withCenter:CGPointMake(-_gap*0.5, _rightDownImage.size.height+0.5*_gap) radius:_radius+_gap startAngle:1.5*M_PI+_atan endAngle:2*M_PI-_atan clockwise:YES];
...
//        [_scrollView setContentOffset:CGPointMake((_scrollView.contentSize.width-_scrollView.frame.size.width)/2, (_scrollView.contentSize.height-_scrollView.frame.size.height)/2)];
        ...
        _scrollView.imageView.image = [ImageUtil drawCircle:_middleImage withCenter:CGPointMake(_scrollView.frame.size.width*0.5, _middleImage.size.height-_scrollView.frame.size.height*0.5) radius:_radius startAngle:0+_atan endAngle:2*M_PI clockwise:YES];
...
- (void)loadScrollViews
{
    ...
    if (self.imagesArray.count == 5) {
        ...
        _scrollView.frame = CGRectMake(_gap, _gap, _currentWidth*0.5-0.5*_gap, _currentHeight*0.5-0.5*_gap);
        _scrollView.delegate = self;

        
        CGPoint p = CGPointMake(_middleMinusWidth, _leftUpImage.size.height-_scrollView.frame.size.height);;
        [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(0, _leftUpImage.size.height-_scrollView.frame.size.height);
        [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(0, _leftUpImage.size.height);
        ...
        _scrollView.imageView.image = [ImageUtil draw5_1_Image:_leftUpImage withPoints:_pointArray withCenter:CGPointMake(_scrollView.frame.size.width+_gap*0.5+_currentOffset.x, _leftUpImage.size.height-_scrollView.frame.size.height-_currentOffset.y-_gap*0.5) radius:_radius+_gap startAngle:M_PI_2+_atan endAngle:0-_atan clockwise:YES];
        ...
        _scrollView.frame = CGRectMake(_gap, _gap+_currentHeight*0.5+0.5*_gap, _currentWidth*0.5-0.5*_gap, _currentHeight*0.5-0.5*_gap);
        _scrollView.delegate = self;
        ...
        _scrollView.imageView.image = [ImageUtil draw5_1_Image:_leftDownImage withPoints:_pointArray withCenter:CGPointMake(_scrollView.frame.size.width+_gap*0.5+_currentOffset.x, _leftDownImage.size.height-_currentOffset.y+_gap*0.5) radius:_radius+_gap startAngle:M_PI+_atan endAngle:1.5*M_PI-_atan clockwise:YES];
        ...
        _scrollView.frame = CGRectMake(_gap+_currentWidth*0.5+0.5*_gap, _gap, _currentWidth*0.5-0.5*_gap, _currentHeight*0.5-0.5*_gap);
        _scrollView.delegate = self;
       ...
       _scrollView.imageView.image = [ImageUtil draw5_1_Image:_rightUpImage withPoints:_pointArray withCenter:CGPointMake(-_gap*0.5+_currentOffset.x, _rightUpImage.size.height-_scrollView.frame.size.height-_currentOffset.y-_gap*0.5) radius:_radius+_gap startAngle:0+_atan endAngle:M_PI_2-_atan clockwise:YES];
        ...
        _scrollView.frame = CGRectMake(_gap+_currentWidth*0.5+0.5*_gap, _gap+_currentHeight*0.5+0.5*_gap, _currentWidth*0.5-0.5*_gap, _currentHeight*0.5-0.5*_gap);
        _scrollView.delegate = self;
        ...
        _scrollView.imageView.image = [ImageUtil draw5_1_Image:_rightDownImage withPoints:_pointArray withCenter:CGPointMake(-_gap*0.5+_currentOffset.x, _rightDownImage.size.height-_currentOffset.y+_gap*0.5) radius:_radius+_gap startAngle:1.5*M_PI+_atan endAngle:2*M_PI-_atan clockwise:YES];
...
- (void)setSelectedImage:(UIImage*)image
{
    ...
    switch (_selectedIndex) {
        case 0:
        {
            ...
            _leftUpImage = [ImageUtil getScaleImage:image withWidth:_currentWidth*0.5-0.5*_gap andHeight:_currentHeight*0.5-0.5*_gap];
            
            [self.leftUpPointArray removeAllObjects];
            
            p = CGPointMake(_middleMinusWidth, _leftUpImage.size.height-_scrollView.frame.size.height);;
            [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
            p = CGPointMake(0, _leftUpImage.size.height-_scrollView.frame.size.height);
            [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
            p = CGPointMake(0, _leftUpImage.size.height);
        ...
        case 1:
        {
            ...
            _scrollView.originImage = image;
            _leftDownImage = [ImageUtil getScaleImage:image withWidth:_currentWidth*0.5-0.5*_gap andHeight:_currentHeight*0.5-0.5*_gap];
            [self.leftDownPointArray removeAllObjects];
        ...
        case 2:
        {
            ...
            _scrollView.originImage = image;
            _rightUpImage = [ImageUtil getScaleImage:image withWidth:_currentWidth*0.5-0.5*_gap andHeight:_currentHeight*0.5-0.5*_gap];
            [self.rightUpPointArray removeAllObjects];
        ...
        case 3:
        {
            ...
            _scrollView.originImage = image;
            _rightDownImage = [ImageUtil getScaleImage:image withWidth:_currentWidth*0.5-0.5*_gap andHeight:_currentHeight*0.5-0.5*_gap];
            [self.rightDownPointArray removeAllObjects];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    else if(scrollView.tag == kIrregularScrollViewStartTag+1)
    {
        ...
        ((ZBIrregularCollageScrollView*)scrollView).imageView.image = [ImageUtil draw5_1_Image:_leftDownImage withPoints:_pointArray withCenter:CGPointMake(scrollView.frame.size.width+_gap*0.5+_currentOffset.x, _leftDownImage.size.height-_currentOffset.y+_gap*0.5) radius:_radius+_gap startAngle:M_PI+_atan endAngle:1.5*M_PI-_atan clockwise:YES];
    ...
    else if(scrollView.tag == kIrregularScrollViewStartTag+2)
    {
        ...
        ((ZBIrregularCollageScrollView*)scrollView).imageView.image = [ImageUtil draw5_1_Image:_rightUpImage withPoints:_pointArray withCenter:CGPointMake(-_gap*0.5+_currentOffset.x, _rightUpImage.size.height-scrollView.frame.size.height-_currentOffset.y-_gap*0.5) radius:_radius+_gap startAngle:0+_atan endAngle:M_PI_2-_atan clockwise:YES];
    }
    else if(scrollView.tag == kIrregularScrollViewStartTag+3)
    {
        ...
        ((ZBIrregularCollageScrollView*)scrollView).imageView.image = [ImageUtil draw5_1_Image:_rightDownImage withPoints:_pointArray withCenter:CGPointMake(-_gap*0.5+_currentOffset.x, _rightDownImage.size.height-_currentOffset.y+_gap*0.5) radius:_radius+_gap startAngle:1.5*M_PI+_atan endAngle:2*M_PI-_atan clockwise:YES];
    }
