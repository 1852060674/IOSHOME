...
@interface ZBTemplate3_5_View()<UIScrollViewDelegate,UIGestureRecognizerDelegate>
{
    float _currentWidth;
...
@implementation ZBTemplate3_5_View
...
- (void)loadImages
{
    ...
    _leftImage = [ImageUtil getScaleImage:_leftImage withWidth:(_currentWidth-2*_gap)*0.35 andHeight:_currentHeight];
    _middleImage = [ImageUtil getScaleImage:_middleImage withWidth:(_currentWidth-2*_gap)*0.4 andHeight:_currentHeight];
    _rightImage = [ImageUtil getScaleImage:_rightImage withWidth:(_currentWidth-2*_gap)*0.35 andHeight:_currentHeight];
}
...
- (void)createScrollView
{
    if (self.imagesArray.count == 3) {
        /********* the firt image ***************/
        ZBIrregularCollageScrollView *_scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap, _gap, (_currentWidth-2*_gap)*0.35, _currentHeight)];
        ...
        [self.leftPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake((_currentWidth-2*_gap)*0.3, _leftImage.size.height);
        [self.leftPointArray addObject:[NSValue valueWithCGPoint:p]];
        ...
        /********* the  second image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap+(_currentWidth-2*_gap)*0.3+_gap, _gap, (_currentWidth-2*_gap)*0.4, _currentHeight)];
        _scrollView.delegate = self;
        ...
        p = CGPointMake(_currentWidth*0.05, _middleImage.size.height-_scrollView.frame.size.height);
        [self.middlePointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_currentWidth-(_currentWidth-2*_gap)*0.65-2*_gap, _middleImage.size.height-_scrollView.frame.size.height);
        [self.middlePointArray addObject:[NSValue valueWithCGPoint:p]];
        ...
        /********* the third image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap+_currentWidth-(_currentWidth-2*_gap)*0.35, _gap, (_currentWidth-2*_gap)*0.35, _currentHeight)];
        _scrollView.delegate = self;
        _scrollView.tag = kIrregularScrollViewStartTag+2;
        _scrollView.originImage = [self.imagesArray objectAtIndex:2];
        
        p = CGPointMake((_currentWidth-2*_gap)*0.05, _rightImage.size.height);;
...
- (void)loadScrollViews
{
    ...
    if (self.imagesArray.count == 3) {
        ...
        _scrollView.frame = CGRectMake(_gap, _gap, (_currentWidth-2*_gap)*0.35, _currentHeight);
        _scrollView.delegate = self;
        ...
        _scrollView.frame = CGRectMake(_gap+(_currentWidth-2*_gap)*0.3+_gap, _gap, (_currentWidth-2*_gap)*0.4, _currentHeight);
        _scrollView.delegate = self;
        ...
        _scrollView.frame = CGRectMake(_gap+_currentWidth-(_currentWidth-2*_gap)*0.35, _gap, (_currentWidth-2*_gap)*0.35, _currentHeight);
        _scrollView.delegate = self;
...
- (void)setSelectedImage:(UIImage*)image
{
    ...
    if (_scrollView.isSelected) {
        if (_isReplace) {
            ...
            _leftImage = [ImageUtil getScaleImage:image withWidth:(_currentWidth-2*_gap)*0.35 andHeight:_currentHeight];
        }
        else
        {
    ...
    else
    {
        ...
        if (_scrollView.isSelected) {
            if (_isReplace) {
                ...
                _middleImage = [ImageUtil getScaleImage:image withWidth:(_currentWidth-2*_gap)*0.4 andHeight:_currentHeight];
            }
            else
            {
        ...
        else
        {
            ...
            if (_scrollView.isSelected) {
                if (_isReplace) {
                    ...
                    _rightImage = [ImageUtil getScaleImage:image withWidth:(_currentWidth-2*_gap)*0.35 andHeight:_currentHeight];
                }
                else
                {
...
//    {
//        
//        _rightImage = [ImageUtil scaleImage:[self.imagesArray objectAtIndex:1] toScale:scale];
//        ((ZBIrregularCollageScrollView*)scrollView).isSelected = YES;
