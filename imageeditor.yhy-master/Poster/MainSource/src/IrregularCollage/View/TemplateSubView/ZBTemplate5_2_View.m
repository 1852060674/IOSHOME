...
@interface ZBTemplate5_2_View()<UIScrollViewDelegate>
{
    float _currentWidth;
...
@implementation ZBTemplate5_2_View
...
- (void)calculatedParameters
{
    ...
    /**** 角度计算 *****/
    _middleMinusWidth = _currentWidth*0.2;;
    _middleMinusHeight = _currentHeight*0.2;
    
    _middleImageWidth = _currentWidth-2*_middleMinusWidth-_gap*2.4;
    _middleImageHeight = _currentHeight - 2*_middleMinusHeight - _gap*2.4;
}
...
- (void)loadImages
{
    ...
    _leftUpImage = [ImageUtil getScaleImage:_leftUpImage withWidth:_currentWidth*0.5 andHeight:_currentHeight*0.5-0.5*_gap];
    _leftDownImage = [ImageUtil getScaleImage:_leftDownImage withWidth:_currentWidth*0.5 andHeight:_currentHeight*0.5-0.5*_gap];
    _rightUpImage = [ImageUtil getScaleImage:_rightUpImage withWidth:_currentWidth*0.5 andHeight:_currentHeight*0.5-0.5*_gap];
    _rightDownImage = [ImageUtil getScaleImage:_rightDownImage withWidth:_currentWidth*0.5 andHeight:_currentHeight*0.5-0.5*_gap];
...
- (void)createScrollView
{
    if (self.imagesArray.count == 5) {
        ...
        /********* the fifth image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap+_middleMinusWidth+_gap*1.2, _gap+_middleMinusHeight+_gap*1.2, _middleImageWidth, _middleImageHeight)];
        _scrollView.delegate = self;
...
- (void)setSelectedImage:(UIImage*)image
{
    ...
    switch (_selectedIndex) {
        case 0:
        {
            ...
            _leftUpImage = [ImageUtil getScaleImage:image withWidth:_currentWidth*0.5 andHeight:_currentHeight*0.5-0.5*_gap];
            [self.leftUpPointArray removeAllObjects];
        ...
        case 1:
        {
            ...
            _scrollView.originImage = image;
            _leftDownImage = [ImageUtil getScaleImage:image withWidth:_currentWidth*0.5 andHeight:_currentHeight*0.5-0.5*_gap];
            [self.leftDownPointArray removeAllObjects];
        ...
        case 2:
        {
            ...
            _scrollView.originImage = image;
            _rightUpImage = [ImageUtil getScaleImage:image withWidth:_currentWidth*0.5 andHeight:_currentHeight*0.5-0.5*_gap];
            [self.rightUpPointArray removeAllObjects];
        ...
        case 3:
        {
            ...
            _scrollView.originImage = image;
            _rightDownImage = [ImageUtil getScaleImage:image withWidth:_currentWidth*0.5 andHeight:_currentHeight*0.5-0.5*_gap];
            [self.rightDownPointArray removeAllObjects];
