...
@interface ZBTemplate4_2_View()<UIScrollViewDelegate>
{
    float _currentWidth;
    ...
    float _leftDownMiddleWidth;
    float _leftDownHeight;
    
    float _rightUpHeight;
    float _rightUpMiddleWidth;
    
    float _rightDownWidth;
...
@implementation ZBTemplate4_2_View
...
- (void)calculatedParameters
{
    ...
    _tanB = (0.2*_currentWidth-_gap)/_currentHeight;
    
    _leftUpWidth = ((0.6*_currentWidth-_gap)/_tanB-(0.4*_currentHeight+_gap))/(_tanA+1/_tanB);
    _leftUpMiddleHeight = _currentHeight - ((0.4*_currentHeight+_gap)/_tanB+_tanA*(0.6*_currentWidth-_gap)/_tanB)/(_tanA+1/_tanB);
    
    _leftDownMiddleWidth = ((0.6*_currentWidth-_gap)/_tanB-0.4*_currentHeight)/(_tanA+1/_tanB);
    _leftDownHeight = (0.4*_currentHeight/_tanB+_tanA*(0.6*_currentWidth-_gap)/_tanB)/(1/_tanB+_tanA);
    
    _rightUpMiddleWidth = (0.6*_currentWidth/_tanB-(0.4*_currentHeight+_gap))/(_tanA+1/_tanB)-0.4*_currentWidth-_gap;
    _rightUpHeight = _currentHeight - ((0.4*_currentHeight+_gap)/_tanB+_tanA*(0.6*_currentWidth)/_tanB)/(_tanA+1/_tanB);
    
    _rightDownWidth = _currentWidth - ((0.6*_currentWidth)/_tanB-(0.4*_currentHeight))/(_tanA+1/_tanB);
    _rightDownMiddleHeight = ((0.4*_currentHeight)/_tanB+_tanA*(0.6*_currentWidth)/_tanB)/(_tanA+1/_tanB);
}
...
- (void)loadImages
{
    ...
    _leftUpImage = [ImageUtil getScaleImage:_leftUpImage withWidth:_leftUpWidth andHeight:_currentHeight*0.6-_gap];
    _leftDownImage = [ImageUtil getScaleImage:_leftDownImage withWidth:_currentWidth*0.6-_gap andHeight:_leftDownHeight];
    _rightUpImage = [ImageUtil getScaleImage:_rightUpImage withWidth:_currentWidth*0.6-_gap andHeight:_rightUpHeight];
    _rightDownImage = [ImageUtil getScaleImage:_rightDownImage withWidth:_rightDownWidth andHeight:_currentHeight*0.6-_gap];
}

- (void)createScrollView
{
    /********* the firt image ***************/
    ZBIrregularCollageScrollView *_scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap, _gap, _leftUpWidth, _currentHeight*0.6-_gap)];
    ...
    [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
    p = CGPointMake(_scrollView.frame.size.width, _leftUpImage.size.height-_leftUpMiddleHeight);
    [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
    p = CGPointMake(_currentWidth*0.4, _leftUpImage.size.height);
    [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
    ...
    /********* the second image ***************/
    _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap, _gap+(_currentHeight-_leftDownHeight), _currentWidth*0.6-_gap, _leftDownHeight)];
    _scrollView.delegate = self;
    ...
    [self.leftDownPointArray addObject:[NSValue valueWithCGPoint:p]];
    p = CGPointMake(_leftDownMiddleWidth, _leftDownImage.size.height);
    [self.leftDownPointArray addObject:[NSValue valueWithCGPoint:p]];
    ...
    /********* the third image ***************/
    _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap+_currentWidth*0.4+_gap, _gap, _currentWidth*0.6-_gap, _rightUpHeight)];
    _scrollView.delegate = self;
    ...
    p = CGPointMake(_rightUpMiddleWidth, _rightUpImage.size.height-_scrollView.frame.size.height);
    [self.rightUpPointArray addObject:[NSValue valueWithCGPoint:p]];
    ...
    /********* the fourth image ***************/
    _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap+_currentWidth-_rightDownWidth, _gap+_currentHeight*0.4+_gap, _rightDownWidth, _currentHeight*0.6-_gap)];
    _scrollView.delegate = self;
    _scrollView.tag = kIrregularScrollViewStartTag+3;
    _scrollView.originImage = [self.imagesArray objectAtIndex:3];
    
    p = CGPointMake(0, _rightDownImage.size.height - (_scrollView.frame.size.height-_rightDownMiddleHeight));
    [self.rightDownPointArray addObject:[NSValue valueWithCGPoint:p]];
    p = CGPointMake(_rightDownWidth-0.4*_currentWidth, _rightDownImage.size.height - _scrollView.frame.size.height);
    [self.rightDownPointArray addObject:[NSValue valueWithCGPoint:p]];
...
- (void)loadScrollViews
{
    ...
    if (self.imagesArray.count == 4) {
        ...
        _scrollView.frame = CGRectMake(_gap, _gap, _leftUpWidth, _currentHeight*0.6-_gap);
        _scrollView.delegate = self;
        ...
        _scrollView.frame = CGRectMake(_gap, _gap+(_currentHeight-_leftDownHeight), _currentWidth*0.6-_gap, _leftDownHeight);
        _scrollView.delegate = self;
        ...
        _scrollView.frame = CGRectMake(_gap+_currentWidth*0.4+_gap, _gap, _currentWidth*0.6-_gap, _rightUpHeight);
        _scrollView.delegate = self;
        ...
        _scrollView.frame = CGRectMake(_gap+_currentWidth-_rightDownWidth, _gap+_currentHeight*0.4+_gap, _rightDownWidth, _currentHeight*0.6-_gap);
        _scrollView.delegate = self;
...
- (void)setSelectedImage:(UIImage*)image
{
    ...
    switch (_selectedIndex) {
        case 0:
        {
            ...
            _leftUpImage = [ImageUtil getScaleImage:image withWidth:_leftUpWidth andHeight:_currentHeight*0.6-_gap];
        ...
        case 1:
        {
            ...
            _leftDownImage = [ImageUtil getScaleImage:image withWidth:_currentWidth*0.6-_gap andHeight:_leftDownHeight];
            _scrollView.originImage = image;
            [self.leftDownPointArray removeAllObjects];
        ...
        case 2:
        {
            ...
            _rightUpImage = [ImageUtil getScaleImage:image withWidth:_currentWidth*0.6-_gap andHeight:_rightUpHeight];
            _scrollView.originImage = image;
            [self.rightUpPointArray removeAllObjects];
        ...
        case 3:
        {
            ...
            _rightDownImage = [ImageUtil getScaleImage:image withWidth:_rightDownWidth andHeight:_currentHeight*0.6-_gap];
            _scrollView.originImage = image;
            [self.rightDownPointArray removeAllObjects];
