...
@interface ZBTemplate5_7_View()<UIScrollViewDelegate>
{
    float _currentWidth;
...
@implementation ZBTemplate5_7_View
...
- (void)loadImages
{
    ...
    _leftUpImage = [ImageUtil getScaleImage:_leftUpImage withWidth:(_currentWidth-_gap)*0.5 andHeight:(_currentHeight-_gap)*0.5];
    _leftDownImage = [ImageUtil getScaleImage:_leftDownImage withWidth:(_currentWidth-_gap)*0.5 andHeight:(_currentHeight-_gap)*0.5];
    _rightUpImage = [ImageUtil getScaleImage:_rightUpImage withWidth:(_currentWidth-_gap)*0.5 andHeight:(_currentHeight-_gap)*0.5];
    _rightDownImage = [ImageUtil getScaleImage:_rightDownImage withWidth:(_currentWidth-_gap)*0.5 andHeight:(_currentHeight-_gap)*0.5];
...
- (void)createScrollView
{
    if (self.imagesArray.count == 5) {
        /********* the firt image ***************/
        ZBIrregularCollageScrollView *_scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap, _gap, (_currentWidth-_gap)*0.5, (_currentHeight-_gap)*0.5)];
        ...
        [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_currentWidth*0.25-_gap, _leftUpImage.size.height-_scrollView.frame.size.height);
        [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_currentWidth*0.368, _leftUpImage.size.height-(_currentHeight-_middleImageHeight)*0.5+_gap);
        [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_scrollView.frame.size.width, _leftUpImage.size.height-(_currentHeight-_middleImageHeight)*0.5+_gap);
        [self.leftUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        ...
        /********* the second image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap, _gap+(_currentHeight-_gap)*0.5+_gap, (_currentWidth-_gap)*0.5, (_currentHeight-_gap)*0.5)];
        _scrollView.delegate = self;
        ...
        [self.leftDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_scrollView.frame.size.width, _leftDownImage.size.height-_middleImageHeight*0.5-0.5*_gap);
        [self.leftDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_currentWidth*0.368, _leftDownImage.size.height-_middleImageHeight*0.5-0.5*_gap);
        [self.leftDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_currentWidth*0.25-_gap, _leftDownImage.size.height);
        [self.leftDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        ...
        /********* the third image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap+(_currentWidth-_gap)*0.5+_gap, _gap, (_currentWidth-_gap)*0.5, (_currentHeight-_gap)*0.5)];
        _scrollView.delegate = self;
        ...
        p = CGPointMake(0, _rightUpImage.size.height-(_currentHeight-_middleImageHeight)*0.5+_gap);
        [self.rightUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_currentWidth*0.13, _rightUpImage.size.height-(_currentHeight-_middleImageHeight)*0.5+_gap);
        [self.rightUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_scrollView.frame.size.width-_currentWidth*0.25+_gap, _rightUpImage.size.height-_scrollView.frame.size.height);
        [self.rightUpPointArray addObject:[NSValue valueWithCGPoint:p]];
        ...
        /********* the fourth image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap+(_currentWidth-_gap)*0.5+_gap, _gap+(_currentHeight-_gap)*0.5+_gap, (_currentWidth-_gap)*0.5, (_currentHeight-_gap)*0.5)];
        _scrollView.delegate = self;
        _scrollView.tag = kIrregularScrollViewStartTag+3;
        _scrollView.originImage = [self.imagesArray objectAtIndex:3];
        
        p = CGPointMake(0, _rightDownImage.size.height -_middleImageHeight*0.5-0.5*_gap);
        ...
        [self.rightDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_scrollView.frame.size.width-_currentWidth*0.25+_gap, _rightDownImage.size.height);
        [self.rightDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        p = CGPointMake(_currentWidth*0.13, _rightDownImage.size.height-_middleImageHeight*0.5-0.5*_gap);
        [self.rightDownPointArray addObject:[NSValue valueWithCGPoint:p]];
        ...
        /********* the fifth image ***************/
        _scrollView = [[ZBIrregularCollageScrollView alloc] initWithFrame:CGRectMake(_gap+_currentWidth*0.25, _gap+(_currentHeight-_middleImageHeight)*0.5, _middleImageWidth, _middleImageHeight)];
        _scrollView.delegate = self;
...
- (void)loadScrollViews
{
    ...
    if (self.imagesArray.count == 5) {
        ...
        _scrollView.frame = CGRectMake(_gap, _gap, (_currentWidth-_gap)*0.5, (_currentHeight-_gap)*0.5);
        _scrollView.delegate = self;
        ...
        _scrollView.frame = CGRectMake(_gap, _gap+(_currentHeight-_gap)*0.5+_gap, (_currentWidth-_gap)*0.5, (_currentHeight-_gap)*0.5);
        _scrollView.delegate = self;
        ...
        _scrollView.frame = CGRectMake(_gap+(_currentWidth-_gap)*0.5+_gap, _gap, (_currentWidth-_gap)*0.5, (_currentHeight-_gap)*0.5);
        _scrollView.delegate = self;
        ...
        _scrollView.frame = CGRectMake(_gap+(_currentWidth-_gap)*0.5+_gap, _gap+(_currentHeight-_gap)*0.5+_gap, (_currentWidth-_gap)*0.5, (_currentHeight-_gap)*0.5);
        _scrollView.delegate = self;
        ...
        _scrollView.frame = CGRectMake(_gap+_currentWidth*0.25, _gap+(_currentHeight-_middleImageHeight)*0.5, _middleImageWidth, _middleImageHeight);
        _scrollView.delegate = self;
...
- (void)setSelectedImage:(UIImage*)image
{
    ...
    switch (_selectedIndex) {
        case 0:
        {
            ...
            _leftUpImage = [ImageUtil getScaleImage:image withWidth:(_currentWidth-_gap)*0.5 andHeight:(_currentHeight-_gap)*0.5];
            [self.leftUpPointArray removeAllObjects];
        ...
        case 1:
        {
            ...
            _scrollView.originImage = image;
            _leftDownImage = [ImageUtil getScaleImage:image withWidth:(_currentWidth-_gap)*0.5 andHeight:(_currentHeight-_gap)*0.5];
            [self.leftDownPointArray removeAllObjects];
        ...
        case 2:
        {
            ...
            _scrollView.originImage = image;
            _rightUpImage = [ImageUtil getScaleImage:image withWidth:(_currentWidth-_gap)*0.5 andHeight:(_currentHeight-_gap)*0.5];
            [self.rightUpPointArray removeAllObjects];
        ...
        case 3:
        {
            ...
            _scrollView.originImage = image;
            _rightDownImage = [ImageUtil getScaleImage:image withWidth:(_currentWidth-_gap)*0.5 andHeight:(_currentHeight-_gap)*0.5];
            [self.rightDownPointArray removeAllObjects];
