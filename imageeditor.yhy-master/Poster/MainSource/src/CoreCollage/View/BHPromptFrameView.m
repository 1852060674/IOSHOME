...
@implementation BHPromptFrameView
...
//    CGPoint secondPoint = CGPointMake(0, self.frame.size.height-10);//
//    CGPoint thirdPoint = CGPointMake((kScreenWidth-20)/2, self.frame.size.height-10);
//    CGPoint fourthPoint = CGPointMake(kScreenWidth/2, self.frame.size.height);
//    CGPoint fivethPoint = CGPointMake((kScreenWidth+20)/2, self.frame.size.height-10);
//    CGPoint sixthPoint = CGPointMake(kScreenWidth, self.frame.size.height-10);
//    CGPoint seventhPoint = CGPointMake(kScreenWidth, 0);
//    
...
//    CGPoint addLines[] =
//	{
//        firstPoint,secondPoint,thirdPoint,fourthPoint,fivethPoint,sixthPoint,seventhPoint,firstPoint
//	};
