...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        NSString *name = [[NSBundle mainBundle] pathForResource:@"start(1242x2208)" ofType:@"png"];
...
-(void)becomeKeyWindow
{
    ...
    BOOL shown = [[AdmobViewController shareAdmobVC] try_show_admob_interstitial:_controller placeid:1 ignoreTimeInterval:NO];
...
-(void)dismiss
{
    ...
    ZBHomePageViewController *uiController = self.preController;
