...
-(NSString *)shareTitleForPlatform:(ZBShareType)shareType
{
    ...
    switch (shareType) {
        ...
        case ZBShareTypeTwitter:
            ...
            break;
        case ZBShareTypeAny:
            title = NSLocalizedStringFromTable(@"SHARE_ANY", @"share", @"instagram for locale");
            break;
        default:
            break;
    }
...
- (void)setupSubView
{
    ...
    CGFloat minimumInteritemSpacing = CGRectGetWidth(frame)*0.00;
    CGFloat minimumLineSpacing = CGRectGetHeight(frame)*0.00;
