...
//    [viewController.view addSubview:contentView];
    ...
    closeButton.frame = CGRectMake(CGRectGetWidth(self.window.bounds)-CGRectGetWidth(closeButton.bounds), 0, CGRectGetWidth(closeButton.bounds), CGRectGetHeight(closeButton.bounds));
    ...
    if (isIpad) {
        ...
        self.closeButton.center = CGPointMake(self.closeButton.center.x-20, self.closeButton.center.y+20);
    }
