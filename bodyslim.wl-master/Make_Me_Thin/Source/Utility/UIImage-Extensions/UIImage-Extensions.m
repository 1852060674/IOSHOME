...
//    float weight[5] = {0.5270270270, 0.5945945946, 0.5216216216, 0.1540540541, 0.2162162162};
    float weight[5] = {0.8, 0.9, 0.8, 0.8, 0.8};
    float _blurValue = 9;
    for (NSInteger i=0; i<5; i++) {
        weight[i]=weight[i]*_blurValue;
    }
    // Blur horizontally
...
-(UIImage *)rotateImage:(UIImage *)aImage andOrientation:(UIImageOrientation)orient
