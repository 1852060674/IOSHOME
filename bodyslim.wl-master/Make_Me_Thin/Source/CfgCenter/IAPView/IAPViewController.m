    ...
    if (ebPurchase.validProduct != nil)
    {
        if (![ebPurchase purchaseProduct:ebPurchase.validProduct])
        {
            dispatch_async(dispatch_get_main_queue(), ^{
                UIAlertController* ac = [UIAlertController alertControllerWithTitle:@"Allow Purchases" message:@"You must first enable In-App Purchase in your iOS Settings before making this purchase." preferredStyle:UIAlertControllerStyleAlert];
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            UIAlertController* ac = [UIAlertController alertControllerWithTitle:@"Failed to Purchases" message:@"Can't find valid In-App item to purchase, please try again later" preferredStyle:UIAlertControllerStyleAlert];
            UIAlertAction* confirm = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
                [self.loadingView stopAnimating];
            }];
            [ac addAction:confirm];
