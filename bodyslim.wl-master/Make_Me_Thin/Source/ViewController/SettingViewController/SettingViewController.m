...
@interface SettingViewController ()<UITableViewDataSource, UITableViewDelegate, UIActionSheetDelegate, ShareServiceDelegate, UIAlertViewDelegate>
...
-(void)doActionForCellAction:(CellAction)action
{
    switch (action) {
        ...
        case CellActionHelp:
        {
            ...
            [self.navigationController presentViewController:_helpVC animated:YES completion:nil];
            break;
        }
        default:
            break;
...
-(NSString *)titleForCellAction:(CellAction)action
{
    ...
    switch (action) {
        ...
        case CellActionHelp:
            title = NSLocalizedStringFromTable(@"SETTING_CLEAR_HELP", @"setting", @"");
            break;
        default:
            break;
    }
...
{
    NSString *path = [[NSBundle mainBundle] pathForResource:@"share_demo" ofType:@"jpg"];
...
-(void)buy
{
    ...
    [self.navigationController presentViewController:purchaseVC animated:YES completion:nil];
