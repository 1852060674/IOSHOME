...
//    }
    ...
    [FIRAnalytics logEventWithName:curr_banner_place parameters:@{@"id": banner_id, @"status": @"load"}];
#endif
}
...
//     CGFloat adjustButtomBanner =0;
// #ifdef UNITY_MODE
//     UIEdgeInsets safeAreaInsets = UIApplication.sharedApplication.windows.firstObject.safeAreaInsets;
//     adjustButtomBanner=-safeAreaInsets.bottom;
// #endif
    if(parent != nil) {
// #ifdef UNITY_MODE
//         UnityAppController* gameScreen = (UnityAppController *)[UIApplication sharedApplication].delegate;
...
//         CGSize ourSize = adBanner.frame.size;
        ...
        // switch (bannerAlign) {
        //     case AD_TOP:///目前生效的主要还是第一部分直接通过frame确定位置
        //         [adBanner setCenter:CGPointMake(size.width/2, ourSize.height/2 + [parent safeAreaInsets].top)];
        //         [parent addConstraint:[NSLayoutConstraint
        //                                constraintWithItem:parent
        ...
        //         break;
        //     case AD_BOTTOM:
        //         [adBanner setCenter:CGPointMake(size.width/2, size.height-ourSize.height/2 -[parent safeAreaInsets].bottom)];
        //         [parent addConstraint:[NSLayoutConstraint
        //                                constraintWithItem:parent
        ...
        [NSLayoutConstraint activateConstraints:@[
            [adBanner.widthAnchor constraintEqualToConstant:parent.frame.size.width],
            [adBanner.heightAnchor constraintEqualToConstant:height]
        ]];
...
#ifdef LOG_USER_ACTION
    [FIRAnalytics logEventWithName:[self adPosition] parameters:@{@"id": interstitial_id, @"status": @"show"}];
#endif
    return YES;
}
...
-(void) _interstitial_reload {
    ...
    [GADInterstitialAd loadWithAdUnitID:interstitial_id
        ...
        if (error) {
#ifdef LOG_USER_ACTION
            [FIRAnalytics logEventWithName:[self adPosition] parameters:@{@"id": interstitial_id, @"status": @"failed"}];
#endif
...
#ifdef LOG_USER_ACTION
            [FIRAnalytics logEventWithName:[self adPosition] parameters:@{@"id": interstitial_id, @"status": @"loaded"}];
#endif
        }
    }];
#ifdef LOG_USER_ACTION
    [FIRAnalytics logEventWithName:[self adPosition] parameters:@{@"id": interstitial_id, @"status": @"load"}];
#endif
}
...
#ifdef LOG_USER_ACTION
    [FIRAnalytics logEventWithName:curr_banner_place parameters:@{@"id": banner_id, @"status": @"loaded", @"click": @"show"}];
#endif
...
#ifdef LOG_USER_ACTION
    [FIRAnalytics logEventWithName:curr_banner_place parameters:@{@"id": banner_id==nil ? @"" : banner_id, @"status": @"failed"}];
#endif
...
#ifdef LOG_USER_ACTION
    [FIRAnalytics logEventWithName:[self adPosition] parameters:@{@"id": interstitial_id, @"status": @"closed"}];
#endif
...
#ifdef LOG_USER_ACTION
    [FIRAnalytics logEventWithName:[self adPosition] parameters:@{@"id": interstitial_id, @"click": @"show"}];
#endif
    if(self.delegate != NULL) {
...
#ifdef LOG_USER_ACTION
    [FIRAnalytics logEventWithName:[self adPosition] parameters:@{@"id": interstitial_id, @"click": @"click"}];
#endif
    if(self.delegate != NULL) {
