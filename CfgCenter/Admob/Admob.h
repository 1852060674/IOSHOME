...
@property (nonatomic, retain) id<AdmobViewControllerDelegate> interadClient;
@property (nonatomic, retain) id<RewardAdWrapperDelegate> rewardAdClient;
@property (nonatomic, retain) id<FullScreenAdWrapperDelegate> openAdClient;
#endif
