...
-(void) updateBannerPos {
    ...
    //     switch (bannerAlign) {
    //         case AD_TOP:
    //             [adView setCenter:CGPointMake(size.width/2, ourSize.height/2 +[parent safeAreaInsets].top)];
    //             [parent addConstraint:[NSLayoutConstraint
    //                                    constraintWithItem:parent
    ...
    //                                    toItem:adView
    //                                    attribute:NSLayoutAttributeTop
    //                                    multiplier:1.0 constant:[parent safeAreaInsets].top]];
    //             break;
    //         case AD_CENTER:
    ...
    //             break;
    //         case AD_BOTTOM:
    //             [adView setCenter:CGPointMake(size.width/2, size.height-ourSize.height/2 -[parent safeAreaInsets].bottom)];
    //             [parent addConstraint:[NSLayoutConstraint
    //             constraintWithItem:parent
    ...
    //             toItem:adView
    //             attribute:NSLayoutAttributeBottom
    //             multiplier:1.0 constant:-[parent safeAreaInsets].bottom]];
    //             break;
    //         default:
    //             break;
    //     }
