...
#define kOutputPath   [NSString stringWithFormat:@"%@/Audio",DOCMENT]
#define kDecode       @"voice_decode"
#define kSoundTouch   @"voice_sound"
#define kEncodeTmp    @"voice_encodetmp"
#define kEncode       @"voiceChanger"
