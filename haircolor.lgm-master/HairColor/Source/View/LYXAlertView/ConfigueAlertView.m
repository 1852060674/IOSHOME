...
- ( instancetype )initWithFrame:(CGRect)frame withGroupNumber:(NSInteger) num{
    ...
    if (self) {
        ...
        _operateLabel.text = NSLocalizedString(@"FIND_HAIR_TIP", @"");
        ...
        _messageLabel.text = NSLocalizedString(@"FIND_HAIR_MSG", @"");
        ...
        _chatLabel.text = NSLocalizedString(@"REMEMBER_CHOOSE", @"");
        ...
        separateBottomLine.frame = CGRectMake(0, CGRectGetMaxY(_chatLabel.frame) + 4 , _alertView.bounds.size.width, 0.5);
        ...
        [_cancelButton setTitle:NSLocalizedString(@"FIND_HAIR_OK", @"") forState:UIControlStateNormal];
        ...
        [_confirmButton setTitle:NSLocalizedString(@"FIND_HAIR_NO", @"") forState:UIControlStateNormal];
