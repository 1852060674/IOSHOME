...
//    CGFloat height = self.size.height*scale;
    ...
    CGFloat width = CGImageGetWidth(self.CGImage)*scale/self.scale;
    CGFloat height = CGImageGetHeight(self.CGImage)*scale/self.scale;
    
//    NSLog(@"image size width: %f, image size height: %f", self.size.width, self.size.height);
//    NSLog(@"CGImage size width: %d, CGImage size height: %d", (int)CGImageGetWidth(self.CGImage), (int)CGImageGetHeight(self.CGImage));
