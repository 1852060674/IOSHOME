...
+(MBProgressHUD *)sharedHUD
{
    ...
    dispatch_once(&once, ^{
        ...
        _progressHUD.labelText = NSLocalizedString(@"WAITING_WORD", @"");
...
+(void)showSharedHUDInView:(UIView *)view
{
    MBProgressHUD *hud = [self sharedHUD];
    hud.labelText = NSLocalizedString(@"WAITING_WORD", @"");
...
+(void)showSharedHUDInView:(UIView *)view withCustomView:(UIView *)customView andTitle:(NSString *)title andDuration:(CGFloat)duration
{
    MBProgressHUD *hud = [self sharedHUD];
...
- (void)showWhileExecuting:(SEL)method onTarget:(id)target withObject:(id)object animated:(BOOL)animated {
    ...
    targetForExecution = target;//[target retain];
    objectForExecution = object;//[object retain];
