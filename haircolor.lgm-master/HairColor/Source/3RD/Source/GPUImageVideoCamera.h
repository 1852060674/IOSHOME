...
@optional
- (void)GPUImageVideoCamera:(GPUImageVideoCamera *)imageVideoCamera willOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer;
- (void)GPUImageVideoCameraWillBeginTakePhoto:(GPUImageVideoCamera *)imageVideoCamera;
- (void)GPUImageVideoCamera:(GPUImageVideoCamera *)imageVideoCamera didEndTakePhoto:(UIImage *)image;
- (void)GPUImageVideoCamera:(GPUImageVideoCamera *)imageVideoCamera beginAdjustFocusAt:(CGPoint) focus;
- (void)GPUImageVideoCamera:(GPUImageVideoCamera *)imageVideoCamera endAdjustFocusAt:(CGPoint) focus;
@end
