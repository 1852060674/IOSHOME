...
-(BOOL) getRT:(UIViewController*)viewctrl settings:(CfgCenterSettings*)cfgSettings isLock:(BOOL)lock rd:(NSString* )rd cb: (CBFUNC)cb
{
    ...
    if(show == 0) {
#ifdef LOG_USER_ACTION
        [Flurry logEvent:@"GRT Return" withParameters:@{@"Accept":@(-1)}];
#endif
        return false;
    }
    ...
    {
#ifdef LOG_USER_ACTION
        [Flurry logEvent:@"GRT Return" withParameters:@{@"Accept":@(-2)}];
#endif
        return false;
    }
...
#ifdef LOG_USER_ACTION
        [Flurry logEvent:@"GRT Return" withParameters:@{@"Accept":@(-8)}];
#endif
        return false;
    }
#endif
...
#ifdef LOG_USER_ACTION
        [Flurry logEvent:@"GRT Return" withParameters:@{@"Accept":@(-4)}];
#endif
        return false;
    }
...
#ifdef LOG_USER_ACTION
        [Flurry logEvent:@"GRT Return" withParameters:@{@"Accept":@(-9)}];
#endif
        return false;
    }
    ...
    if(!lock) {
        ...
        {
#ifdef LOG_USER_ACTION
            [Flurry logEvent:@"GRT Return" withParameters:@{@"Accept":@(-3)}];
#endif
            return false;
        }
...
#ifdef LOG_USER_ACTION
            [Flurry logEvent:@"GRT Return" withParameters:@{@"Accept":@(-5)}];
#endif
            return false;
        }
...
#ifdef LOG_USER_ACTION
            [Flurry logEvent:@"GRT Return" withParameters:@{@"Accept":@(-6)}];
#endif
            return false;
        }
...
#ifdef LOG_USER_ACTION
            [Flurry logEvent:@"GRT Return" withParameters:@{@"Accept":@(-7)}];
#endif
            return false;
        }
    }
...
#ifdef LOG_USER_ACTION
    [Flurry logEvent:@"GRT Return" withParameters:@{@"Show":@(0)}];
#endif
...
-(UIAlertView* ) createAlertViewTypB:(UIViewController*)viewctrl {
    ...
    UIAlertView *rateDlg = [[UIAlertView alloc]
                            ...
                            otherButtonTitles:NSLocalizedStringFromTable(@"SETTING_IOS_DESC_WORD", @"RTService", nil), NSLocalizedStringFromTable(@"RATE_NO", @"RTService", nil), nil];
...
-(void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    if(alertView.tag == REVIEW_GET_ALERTVIEW_TAG)
    {
        switch (buttonIndex) {
            case 1:
#ifdef LOG_USER_ACTION
                [Flurry logEvent:@"GRT Return" withParameters:@{@"Show":@(2)}];
#endif
                [self doRT];
                if(cbfunc != nil) {
                    cbfunc();
            ...
            default:
#ifdef LOG_USER_ACTION
                [Flurry logEvent:@"GRT Return" withParameters:@{@"Show":@(1)}];
#endif
                break;
        }
    }
