...
{
    if (_imageView == nil) {
        _imageView = [[UIImageView alloc] initWithFrame:UIEdgeInsetsInsetRect(self.bounds, UIEdgeInsetsMake(0, CGRectGetHeight(self.bounds)*self.titleRatio*0.5, CGRectGetHeight(self.bounds)*self.titleRatio, CGRectGetHeight(self.bounds)*self.titleRatio*0.5))];
        _imageView.contentMode = UIViewContentModeScaleAspectFit;
        _imageView.clipsToBounds = YES;
        _imageView.layer.cornerRadius = CGRectGetHeight(_imageView.frame)*0.5;
        _imageView.layer.borderColor = [UIColor colorWithHexString:@"b3b3b3"].CGColor;
...
-(UILabel *)titleLabel
{
    if (_titleLabel == nil) {
        ...
        _titleLabel.textColor = [UIColor colorWithHexString:@"2f2633"];
...
//    
//    if (self.shouldShowSelectedStatus) {
//        self.centerImageView.hidden = !selected;
////        if (selected) {
