...
MyGCGraph_double::MyGCGraph_double()
{
    flow = 0;
}

MyGCGraph_double::MyGCGraph_double( unsigned int vtxCount, unsigned int edgeCount )
{
...
void MyGCGraph_double::create( unsigned int vtxCount, unsigned int edgeCount )
{
...
void MyGCGraph_double::addEdges( int i, int j, double w, double revw )
{
...
void MyGCGraph_double::addTermWeights( int i, double sourceW, double sinkW )
{
    CV_Assert( i>=0 && i<(int)vtcs.size() );
...
double MyGCGraph_double::maxFlow()
{
...
bool MyGCGraph_double::inSourceSegment( int i )
{
    CV_Assert( i>=0 && i<(int)vtcs.size() );
    return vtcs[i].t == 0;
};
