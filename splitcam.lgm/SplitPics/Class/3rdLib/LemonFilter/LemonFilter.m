...
NSString *const kLemonFilterVertexShaderString = SHADER_STRING
(
...
@interface LemonFilter ()
{
    NSInteger textureNum;
}
@end

@implementation LemonFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kLemonFilterVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
...
- (void)newFrameReadyAtTime:(CMTime)frameTime atIndex:(NSInteger)textureIndex;
{
    ...
    if (((hasReceivedFirstFrame||!hasSetFirstTexture) && (hasReceivedSecondFrame||!hasSetSecondTexture)
         && (hasReceivedThirdFrame||!hasSetThirdTexture) && (hasReceivedFourthFrame||!hasSetFouredTexture)
         && (hasReceivedFifthFrame||!hasSetFifthTexture) && (hasReceivedSixthFrame||!hasSetSixthTexture)
         && (hasReceivedSeventhFrame||!hasSetSeventhTexture)))
    {
