...
- (void)awakeFromNib {
  ...
  self.titleLabel.text = LocalizedGameStr2(help_rules);
  ...
  self.textV.text = [NSString stringWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"rules" ofType:@"txt"] encoding:(NSUTF8StringEncoding) error:nil];
}
