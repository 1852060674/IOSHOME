...
- (void)awakeFromNib {
  [super awakeFromNib];
  self.titleLabel.text = LocalizedGameStr2(stats);
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
  ...
  if (self.isp) {
    CGFloat height = CGRectGetHeight(rect)/NUM_CELL_PER_SUIT;
...
//  BOOL suitPlaceHolder = isp?(idx/NUM_CELL_PER_SUIT == 3):(idx/NUM_CELL_PER_SUIT >= 2 && idx%2==1);
  ...
  switch (idx+1) {
                case 1:
                  cell.keyLabel.text = LocalizedGameStr2(stat_won);
                  cell.valueLabel.text = [NSString stringWithFormat:@"%ld(%0.0f%%)",(long)ds.wonCnt,100.0*ds.wonCnt/(ds.wonCnt+ds.lostCnt+0.000001)];
                  return cell;
                  break;
                case 2:
                  cell.keyLabel.text = LocalizedGameStr2(stat_lose);
                  cell.valueLabel.text = [NSString stringWithFormat:@"%ld",(long)ds.lostCnt];
                  return cell;
                  break;
                case 3:
                  cell.keyLabel.text = LocalizedGameStr2(Best Score);
                  cell.valueLabel.text = [NSString stringWithFormat:@"%ld",(long)ds.bestScore];
                  return cell;
                  break;
                case 4:
                  cell.keyLabel.text = LocalizedGameStr2(Worst Score);
                  cell.valueLabel.text = [NSString stringWithFormat:@"%ld",(long)ds.worstScore];
                  return cell;
                  break;
