...
{
#ifdef LOG_USER_ACTION
    [Flurry logEvent:@"Active User"  withParameters:@{@"Open Times": [NSString stringWithFormat:@"Opens:%ld", [settings getAppOpenCountTotal]]}];
#endif
...
#ifdef LOG_USER_ACTION
    [Flurry logEvent:@"Active User"  withParameters:@{@"Login Days": [NSString stringWithFormat:@"Days:%d", login_cnt]}];
#endif
...
//                             kBannerID2, kInterstitialID2, @"",
//                             kBannerID3, kInterstitialID3, @"",
//                             kBannerID4, kInterstitialID4, @"",
//                             kBannerID5, kInterstitialID5, @"",
//                             kBannerID, kInterstitialID, @"",
//                             wt];

    NSString* buildin = [NSString stringWithFormat:@"{\"retcode\":\"1\",\"ad\":{\"type\":\"priority\",\"ads\":["
                          "{\"type\":\"maxwrap\",\"banner\":\"%@\",\"interstitial\":\"%@\", \"fg\":300, \"bg\":600},"
                          "{\"type\":\"admob\",\"banner\":\"%@\",\"interstitial\":\"%@\",\"native\":\"%@\", \"bg\":90,\"bbid\":0.96},"
                          "{\"type\":\"admob\",\"banner\":\"%@\",\"interstitial\":\"%@\",\"native\":\"%@\", \"bg\":90,\"bbid\":0.24}"
                         "]},"
                         "\"rt\":{\"s\":0,\"fi\":-172800,\"op\":3,\"ts\":3,\"tao\":30,\"wt\":%@,\"it\":0},\"vd\":86400,\"t\":0"
                         "}",
...
-(BOOL) admob_interstial_ready:(int)place {//zzx
